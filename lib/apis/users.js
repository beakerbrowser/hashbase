...
var {UnauthorizedError, NotFoundError, NotImplementedError} = require('../const')
...
module.exports = class UsersAPI {
  ...
  async getRegister (req, res) {
    ...
    res.render('register', { values: { username: '', email: '', password: '' } })
  }
  ...
  async doLogin (req, res) {
    ...
    req.checkBody('password').isLength({ min: 6, max: 100 })
    ;(await req.getValidationResult()).throw()
