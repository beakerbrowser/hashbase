...
module.exports = function (config) {
  ...
  app.get('/v1/admin/analytics/visits', cloud.api.admin.getAnalyticsVisitsList)
  app.get('/v1/admin/analytics/visits-count', cloud.api.admin.getAnalyticsVisitsCount)
